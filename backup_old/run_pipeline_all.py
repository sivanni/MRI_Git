...
for k in range(2,3):
	...
	func1 = results_path + subj + '/func1_2/warpall/drifter_corrected_calc_trim_intnorm_warp.nii.gz'
	func2 = results_path + subj + '/func2_2/warpall/drifter_corrected_calc_trim_intnorm_warp.nii.gz'
