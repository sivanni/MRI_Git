...
for session in (['1', '2', '3']):
	...
	results_path = ['/opt/MR_data/Silja_Raty/Revis_0007_rs/Results/Functional/data'+session+'/'] 
	...
	for data in (['func1','func2']):
		...
		func1 = data_path +  '/sessio'+session+'_a/epi.nii.gz'
		func2 = data_path + '/sessio'+session+'_b/epi.nii.gz'
		try:
			anat = '/opt/MR_data/Silja_Raty/Revis_0007_rs/Results/00002_session'+session+'/anat/nonlinear_reg/anat_LR_warp_reoriented_skullstrip_warped.nii.gz'
			field_file = '/opt/MR_data/Silja_Raty/Revis_0007_rs/Results/00002_session'+session+'/anat/nonlinear_reg/anat_LR_warp_reoriented_skullstrip_fieldwarp.nii.gz'
		except:
			anat = '/opt/MR_data/Silja_Raty/Revis_0007_rs/Results/00002_session'+session+'/anat/nonlinear_reg/anat_HR_warp_reoriented_skullstrip_warped.nii.gz'
			field_file = '/opt/MR_data/Silja_Raty/Revis_0007_rs/Results/00002_session'+session+'/anat/nonlinear_reg/anat_HR_warp_reoriented_skullstrip_fieldwarp.nii.gz'

		# Physiological signal files
		physsig1 = '/opt/MR_data/Silja_Raty/Revis_0007_rs/Biopac/'+session+'.sessio/pulse_fMRI1.mat'
		physsig2 = '/opt/MR_data/Silja_Raty/Revis_0007_rs/Biopac/'+session+'.sessio/resp_fMRI1.mat'
		physsig3 = '/opt/MR_data/Silja_Raty/Revis_0007_rs/Biopac/'+session+'.sessio/pulse_fMRI2.mat'
		physsig4 = '/opt/MR_data/Silja_Raty/Revis_0007_rs/Biopac/'+session+'.sessio/resp_fMRI2.mat'
